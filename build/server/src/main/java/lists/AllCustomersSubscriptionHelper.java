...
public class AllCustomersSubscriptionHelper implements FlowableOnSubscribe<DataQueryDataChange> {
  ...
  public void handleContextStart(DataQueryDataChange event) {
    updateData(event);
    try {
      event.data = allCustomersImpl.getAsJson(field, event.nativeData);
  ...
  private void loadInitialData() {
    ...
    change.nativeData = allCustomersImpl.getNativeResult();
