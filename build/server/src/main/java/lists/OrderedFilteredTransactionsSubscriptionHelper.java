...
public class OrderedFilteredTransactionsSubscriptionHelper
  ...
  public void handleContextStart(DataQueryDataChange event) {
    updateData(event);
    try {
      event.data = orderedFilteredTransactionsImpl.getAsJson(field, event.nativeData);
  ...
  private void loadInitialData() {
    ...
    change.nativeData = orderedFilteredTransactionsImpl.getNativeResult();
