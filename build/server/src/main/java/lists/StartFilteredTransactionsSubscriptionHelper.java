...
public class StartFilteredTransactionsSubscriptionHelper
  ...
  public void handleContextStart(DataQueryDataChange event) {
    updateData(event);
    try {
      event.data = startFilteredTransactionsImpl.getAsJson(field, event.nativeData);
  ...
  private void loadInitialData() {
    ...
    change.nativeData = startFilteredTransactionsImpl.getNativeResult(this.inputs);
  ...
  public Flowable<DataQueryDataChange> subscribe(
      Field field, StartFilteredTransactionsRequest inputs) {
    {
